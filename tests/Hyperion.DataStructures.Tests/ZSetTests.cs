...
public class ZSetTests
{
    ...
    public void Add_ShouldAddAndReturnCorrectCount()
    {
        ...
        Assert.Equal(0, zs.Add(20.0, "b")); // Already exists, score same
        Assert.Equal(0, zs.Add(25.0, "b")); // Exists, score updated
    ...
    public void Rem_ShouldRemoveElement()
    {
        ...
        Assert.Equal(0, zs.Rem("a")); // Already removed
    ...
    public void GetRank_ShouldReturnCorrectRank()
    {
        ...
        // Reverse order: c(30)[0], b(20)[1], a(10)[2]
